...
public class CotizacionService {
    ...
    public List<Cotizacion> getCotizacionesPorDocumento(String nroDocumento){
        return cotizacionRepository.findByNroDocumento(nroDocumento);
    }
    
    public List<String> getNroDocumentosConGastos(){
        return cotizacionRepository.findNroDocumentosConGastos();
    }
    
    public List<Cotizacion> getIdCotizacionesConGastosPorNroDocumento(String nroDocumento){
        return cotizacionRepository.findIdCotizacionesConGastosPorNroDocumento(nroDocumento);
    }
